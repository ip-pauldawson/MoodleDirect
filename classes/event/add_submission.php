...
class add_submission extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('addsubmission', 'mod_turnitintool');
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, "turnitintool", "add submission", 'view.php?id='.$this->objectid, $this->other['desc'], $this->objectid);
    }
